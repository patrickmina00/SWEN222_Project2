...
public class DropTest {
	...
	public void setUp() throws Exception {
		URL saveUrl = DropTest.class.getResource("TestControllerExcellentAdventure-Save.xml");
	...
	public void test() {
		...
		ItemNode testItemNode = new ItemNode(9, ItemState.DEFAULT, Type.REMOVABLE);

		singlePlayer.dropItem(testItemNode);
		...
		for(Item item : items){
			...
			if(i == 9){
				assertTrue("Sucessfully dropped item", true);
			}
