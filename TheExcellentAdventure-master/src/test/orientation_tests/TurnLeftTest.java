...
public class TurnLeftTest {
	...
	public void setUp() throws Exception {
		URL saveUrl = TurnLeftTest.class.getResource("TestOrientationExcellentAdventure-Save.xml");
	...
	/**
	 * Testing that turning left works
	 */
	@Test
	public void test() {
		...
		assertTrue("Player turned left", pAfter.getOrientation() == Orientation.WEST);
