...
public class GenericRoom2Drawer implements Drawer{
	...
	public GenericRoom2Drawer(ArrayList<BasicNode> children, Controller controller){
	...
	if(orientation.equals(Orientation.NORTH)){
			...
			ForegroundDrawer.drawDoorIrradiatedRight(g, gamePanel);
		}
